...
#ifndef TECTONICTYPES_H
#define TECTONICTYPES_H
...
namespace ed {
	...
	struct TecPoint : IndexedComponent {
		Vec3 pos;
		TecPlate* plate;
		SmallList<int> welds; // simplest snap connections
		// goal point is average of all connected points
	};

	struct TecPlate : IndexedComponent {
		SmallList<TecPoint> points;
